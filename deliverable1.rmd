...
The code below sets up tables to be joined together by decade and state with the violent crime statistics in the next phase.

```{r}
long<-pivot_longer(eduLevelsbyCounty, -c("state", "area_name"),
            names_to = c(".value", "year"), 
            names_sep = ",", values_drop_na = TRUE) 

long_pre_join <- select(long, 1:7)
...
states_decades <- filter(long_pre_join, area_name %in% states_vec)

alabama_ed_decades <- filter(states_decades, area_name == "Alabama")
alaska_ed_decades <- filter(states_decades, area_name == "Alaska")
arizona_ed_decades <- filter(states_decades, area_name == "Arizona")
arkansas_ed_decades <- filter(states_decades, area_name == "Arkansas")
california_ed_decades <- filter(states_decades, area_name == "California")
colorado_ed_decades <- filter(states_decades, area_name == "Colorado")
connecticut_ed_decades <- filter(states_decades, area_name == "Connecticut")
delaware_ed_decades <- filter(states_decades, area_name == "Delaware")
dc_ed_decades <- filter(states_decades, area_name == "D.C.")
florida_ed_decades <-  filter(states_decades, area_name == "Florida")
georgia_ed_decades <- filter(states_decades, area_name == "Georgia")
hawaii_ed_decades <- filter(states_decades, area_name == "Hawaii")
idaho_ed_decades <- filter(states_decades, area_name == "Idaho")
illinois_ed_decades <- filter(states_decades, area_name == "Illinois")      
indiana_ed_decades <- filter(states_decades, area_name == "Indiana")
iowa_ed_decades <- filter(states_decades, area_name == "Iowa")
kansas_ed_decades <- filter(states_decades, area_name == "Kansas")
kentucky_ed_decades <- filter(states_decades, area_name == "Kentucky")
louisiana_ed_decades <- filter(states_decades, area_name == "Louisiana")
maine_ed_decades <- filter(states_decades, area_name == "Maine")
maryland_ed_decades <- filter(states_decades, area_name == "Maryland")
mass_ed_decades <- filter(states_decades, area_name == "Massachusetts")
michigan_ed_decades <- filter(states_decades, area_name == "Michigan")
minnesota_ed_decades <- filter(states_decades, area_name == "Minnesota")
mississippi_ed_decades <- filter(states_decades, area_name == "Mississippi")
missouri_ed_decades <- filter(states_decades, area_name == "Missouri")
montana_ed_decades <- filter(states_decades, area_name == "Montana")
nebraska_ed_decades <- filter(states_decades, area_name == "Nebraska")
nevada_ed_decades <- filter(states_decades, area_name == "Nevada")
newHampshire_ed_decades <- filter(states_decades, area_name == "New Hampshire")
newJersey_ed_decades <- filter(states_decades, area_name == "New Jersey")
newMexico_ed_decades <- filter(states_decades, area_name == "New Mexico")
newYork_ed_decades <- filter(states_decades, area_name == "New York")
northCarolina_ed_decades <- filter(states_decades, area_name == "North Carolina")
northDakota_ed_decades <- filter(states_decades, area_name == "North Dakota")
ohio_ed_decades <- filter(states_decades, area_name == "Ohio")
oklahoma_ed_decades <- filter(states_decades, area_name == "Oklahoma")
oregon_ed_decades <- filter(states_decades, area_name == "Oregon")
pennslyvania_ed_decades <- filter(states_decades, area_name == "Pennslyvania")
rhodeIsland_ed_decades <- filter(states_decades, area_name == "Rhode Island")
southCarolina_ed_decades <- filter(states_decades, area_name == "South Carolina")
southDakota_ed_decades <- filter(states_decades, area_name == "South Dakota")
tennessee_ed_decades <- filter(states_decades, area_name == "Tennessee")
texas_ed_decades <- filter(states_decades, area_name == "Texas")
utah_ed_decades <- filter(states_decades, area_name == "Utah")
vermont_ed_decades <- filter(states_decades, area_name == "Vermont")
virginia_ed_decades <- filter(states_decades, area_name == "Virginia")
washington_ed_decades <- filter(states_decades, area_name == "Washington")
westVirginia_ed_decades <- filter(states_decades, area_name == "West Virginia")
wisconsin_ed_decades <- filter(states_decades, area_name == "Wisconsin")
wyoming_ed_decades <- filter(states_decades, area_name == "Wyoming")
